...
@include('partials.layouts.navbar')
    <div class="container venue-section">
        ...
        <div class="row mb-4">
            <div class="col-md-6">
                <img src="{{ asset('dist/assets/img/sample3.webp') }}" alt="Party Space" class="img-fluid venue-image" />
            </div>
            <div class="col-md-6">
                <h1>Party Spaces</h1>
                <p>{{ $venueDetails }}</p>
        ...
        <div class="row booking-form" id="bookingForm">  
            <div class="col-md-12">
                <h2>Fill out the form to book a Party Space</h2>
                <form action="{{ route('venues.party.submit') }}" method="POST">
                    @csrf
                    <div class="form-group">
                        <label for="venueName">Party Space Name</label>
